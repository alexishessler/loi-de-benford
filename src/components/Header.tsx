      ...
      <div className="bg-white px-4 sm:px-6 py-3">
        <div className="max-w-4xl mx-auto flex items-center gap-3.5">
          ...
          <img
            ...
            width={40}
            height={40}
            className="w-10 h-10 rounded-full ring-2 ring-[var(--french-blue)]/15 avatar-ring object-cover"
          />

          {/* Title block */}
          <div className="min-w-0">
            <h1 className="text-base sm:text-lg font-extrabold tracking-tight gradient-text truncate">
              Loi de Benford
            </h1>
            <p className="text-[10.5px] sm:text-[11px] text-[var(--text-tertiary)] tracking-wide">
              Testez la naturalit&eacute; de vos donn&eacute;es
            </p>
          </div>
